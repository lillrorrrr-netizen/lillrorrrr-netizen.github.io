...
export interface AmplitudeSessionReplay {
    ...
    evaluateTargetingAndCapture: (targetingParams: SessionReplayTargetingInput, isInit?: boolean, forceRestart?: boolean, forceTargetingReevaluation?: boolean) => Promise<void>;
