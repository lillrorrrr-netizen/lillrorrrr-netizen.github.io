/* @amplitude/experiment-js-client v1.21.1 - For license info see https://app.unpkg.com/@amplitude/experiment-js-client@1.21.1/files/LICENSE */
(function (global, factory) {
    ...
    ***************************************************************************** */
    ...
    var EvaluationEngine = /** @class */function () {
      ...
      /** @alpha */
      EvaluationEngine.prototype.evaluateWithTraces = function (context, flags) {
        var e_2, _a;
        var results = {};
        var traces = {};
        var target = {
        ...
        try {
          for (var flags_2 = __values$1(flags), flags_2_1 = flags_2.next(); !flags_2_1.done; flags_2_1 = flags_2.next()) {
            var flag = flags_2_1.value;
            var _b = this.evaluateFlagWithTrace(target, flag),
              variant = _b.variant,
              trace = _b.trace;
            if (variant) {
              results[flag.key] = variant;
          ...
          try {
            if (flags_2_1 && !flags_2_1.done && (_a = flags_2.return)) _a.call(flags_2);
          } finally {
      ...
      EvaluationEngine.prototype.evaluateFlagWithTrace = function (target, flag) {
        var e_4, _a, e_5, _b, e_6, _c;
        var _d, _e;
        var steps = [];
        var winnerVariant;
        var winnerSegment;
        var matchedSegmentName;
        try {
          for (var _f = __values$1(flag.segments), _g = _f.next(); !_g.done; _g = _f.next()) {
            var segment = _g.value;
            if (!segment.conditions) {
              var variantKey = this.bucket(target, segment);
              var bucketed_1 = variantKey !== undefined;
              steps.push({
              ...
              if (!winnerVariant && variantKey !== undefined) {
                ...
                matchedSegmentName = (_d = segment.metadata) === null || _d === void 0 ? void 0 : _d.segmentName;
              }
              continue;
            }
            ...
            try {
              for (var _h = (e_5 = void 0, __values$1(segment.conditions)), _j = _h.next(); !_j.done; _j = _h.next()) {
                var innerConditions = _j.value;
                var match = true;
                var andConditionResults = [];
                try {
                  for (var innerConditions_1 = (e_6 = void 0, __values$1(innerConditions)), innerConditions_1_1 = innerConditions_1.next(); !innerConditions_1_1.done; innerConditions_1_1 = innerConditions_1.next()) {
                    var condition = innerConditions_1_1.value;
                    var propValue = select(target, condition.selector);
                    var conditionMatch = this.matchCondition(target, condition);
                  ...
                  try {
                    if (innerConditions_1_1 && !innerConditions_1_1.done && (_c = innerConditions_1.return)) _c.call(innerConditions_1);
                  } finally {
            ...
            if (segmentMatched && bucketVariant !== undefined && !winnerVariant) {
              ...
              winnerSegment = segment;
              matchedSegmentName = (_e = segment.metadata) === null || _e === void 0 ? void 0 : _e.segmentName;
            }
          }
        } catch (e_4_1) {
          e_4 = {
        ...
        if (winnerVariant && winnerSegment) {
          var metadata = __assign$1(__assign$1(__assign$1({}, flag.metadata), winnerSegment.metadata), winnerVariant.metadata);
          winnerVariant = __assign$1(__assign$1({}, winnerVariant), {
            metadata: metadata
          });
        }
        var trace = {
      ...
      EvaluationEngine.prototype.evaluateConditions = function (target, conditions) {
        ...
        try {
          ...
          for (var conditions_1 = __values$1(conditions), conditions_1_1 = conditions_1.next(); !conditions_1_1.done; conditions_1_1 = conditions_1.next()) {
            ...
            var match = true;
            try {
              for (var innerConditions_2 = (e_8 = void 0, __values$1(innerConditions)), innerConditions_2_1 = innerConditions_2.next(); !innerConditions_2_1.done; innerConditions_2_1 = innerConditions_2.next()) {
                var condition = innerConditions_2_1.value;
              ...
              try {
                if (innerConditions_2_1 && !innerConditions_2_1.done && (_b = innerConditions_2.return)) _b.call(innerConditions_2);
              } finally {
        ...
        try {
          for (var _c = __values$1(segment.bucket.allocations), _d = _c.next(); !_d.done; _d = _c.next()) {
            ...
            if (allocationValue >= allocationStart && allocationValue < allocationEnd) {
              try {
                for (var _e = (e_10 = void 0, __values$1(allocation.distributions)), _f = _e.next(); !_f.done; _f = _e.next()) {
      ...
      EvaluationEngine.prototype.matchStringsNonSet = function (propValues, op, filterValues) {
        var _this = this;
        return propValues.some(function (element) {
          return _this.matchString(element, op, filterValues);
        });
      };
      ...
      EvaluationEngine.prototype.coerceStringArray = function (value) {
        ...
        try {
          ...
          if (Array.isArray(parsedValue)) {
            return parsedValue.map(function (e) {
              return _this.coerceString(e);
            }).filter(Boolean);
          } else {
            return undefined;
    ...
    ***************************************************************************** */
    ...
    var IntegrationManager = /** @class */ (function () {
         ...
         * @param user
         */
        IntegrationManager.prototype.track = function (exposure, user) {
    ...
    var SessionDedupeCache = /** @class */ (function () {
        function SessionDedupeCache(instanceName) {
            ...
            this.inMemoryCache = {};
            this.identity = {};
            this.storageKey = "EXP_sent_v3_".concat(instanceName);
            ...
            if (this.isSessionStorageAvailable) {
                ...
                safeGlobal$1.sessionStorage.removeItem("EXP_sent_v2_".concat(instanceName));
            }
        }
        SessionDedupeCache.prototype.shouldTrack = function (exposure, user) {
            var _a, _b;
            ...
            this.loadCache();
            var hasKey = exposure.flag_key in this.inMemoryCache;
            var cachedVariant = this.inMemoryCache[exposure.flag_key];
            ...
            var normalizedExposureVariant = (_b = exposure.variant) !== null && _b !== void 0 ? _b : null;
            var normalizedCachedVariant = cachedVariant !== null && cachedVariant !== void 0 ? cachedVariant : null;
        ...
        SessionDedupeCache.prototype.clearCache = function () {
            this.inMemoryCache = {};
            if (this.isSessionStorageAvailable) {
                safeGlobal$1.sessionStorage.removeItem(this.storageKey);
            }
        };
        SessionDedupeCache.prototype.identityEquals = function (id1, id2) {
    ...
    var ExperimentClient = /** @class */ (function () {
        ...
        function ExperimentClient(apiKey, config) {
            ...
            this.poller = new Poller(function () { return __awaiter$1(_this, void 0, void 0, function () {
                var e_1;
                return __generator$1(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            _a.trys.push([0, 2, , 3]);
                            return [4 /*yield*/, this.doFlags()];
                        case 1:
                            _a.sent();
                            return [3 /*break*/, 3];
                        case 2:
                            e_1 = _a.sent();
                            this.logger.info(e_1);
                            return [3 /*break*/, 3];
                        case 3: return [2 /*return*/];
                    }
                });
        ...
        ExperimentClient.prototype.start = function (user) {
            return __awaiter$1(this, void 0, void 0, function () {
                var flagsReadyPromise, fetchOnStart, e_2;
                var _a;
                return __generator$1(this, function (_b) {
                    switch (_b.label) {
                        case 0:
        ...
        /** @alpha */
        ExperimentClient.prototype.getEvaluationTraces = function (flagKeys) {
            var user = this.addContext(this.user);
            var flags = topologicalSort(this.flags.getAll(), flagKeys);
            var context = convertUserToContext(user);
            var traces = this.engine.evaluateWithTraces(context, flags).traces;
            return traces;
        };
            ...
            return __awaiter$1(this, void 0, void 0, function () {
                ...
                return __generator$1(this, function (_b) {
                    switch (_b.label) {
                        ...
                        case 4:
                            e_5 = _b.sent();
                            if (retry && this.shouldRetryFetch(e_5)) {
            ...
            return __awaiter$1(this, void 0, void 0, function () {
                ...
                return __generator$1(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 4:
                            e_7 = _a.sent();
                            if (e_7 instanceof TimeoutError) {
                                this.logger.debug(e_7);
