...
import { MaskAttributeFn } from '@amplitude/rrweb-snapshot';
...
export declare class Replayer {
    ...
    private mousePos;
    private touchActive;
    private seekInProgress;
    private pendingCaptureTimer;
...
declare interface SnapshotCheckpoint {
