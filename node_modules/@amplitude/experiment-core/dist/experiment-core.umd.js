    ...
    ***************************************************************************** */
    ...
    var EvaluationEngine = /** @class */ (function () {
        ...
        EvaluationEngine.prototype.evaluateWithTraces = function (context, flags) {
            ...
            try {
                for (var flags_2 = __values(flags), flags_2_1 = flags_2.next(); !flags_2_1.done; flags_2_1 = flags_2.next()) {
                    ...
                    var _b = this.evaluateFlagWithTrace(target, flag), variant = _b.variant, trace = _b.trace;
                    if (variant) {
                        results[flag.key] = variant;
                    }
        ...
        EvaluationEngine.prototype.evaluateFlagWithTrace = function (target, flag) {
            ...
            try {
                for (var _f = __values(flag.segments), _g = _f.next(); !_g.done; _g = _f.next()) {
                    ...
                    try {
                        for (var _h = (e_5 = void 0, __values(segment.conditions)), _j = _h.next(); !_j.done; _j = _h.next()) {
                            var innerConditions = _j.value;
                            var match = true;
                            var andConditionResults = [];
                            try {
                                for (var innerConditions_1 = (e_6 = void 0, __values(innerConditions)), innerConditions_1_1 = innerConditions_1.next(); !innerConditions_1_1.done; innerConditions_1_1 = innerConditions_1.next()) {
            ...
            if (winnerVariant && winnerSegment) {
                var metadata = __assign(__assign(__assign({}, flag.metadata), winnerSegment.metadata), winnerVariant.metadata);
                winnerVariant = __assign(__assign({}, winnerVariant), { metadata: metadata });
            }
            var trace = {
                flagKey: flag.key,
            ...
            return { variant: winnerVariant, trace: trace };
        };
        ...
        EvaluationEngine.prototype.evaluateConditions = function (target, conditions) {
            ...
            try {
                ...
                for (var conditions_1 = __values(conditions), conditions_1_1 = conditions_1.next(); !conditions_1_1.done; conditions_1_1 = conditions_1.next()) {
                    ...
                    var match = true;
                    try {
                        for (var innerConditions_2 = (e_8 = void 0, __values(innerConditions)), innerConditions_2_1 = innerConditions_2.next(); !innerConditions_2_1.done; innerConditions_2_1 = innerConditions_2.next()) {
            ...
            try {
                for (var _c = __values(segment.bucket.allocations), _d = _c.next(); !_d.done; _d = _c.next()) {
                    ...
                    if (allocationValue >= allocationStart &&
                        ...
                        try {
                            for (var _e = (e_10 = void 0, __values(allocation.distributions)), _f = _e.next(); !_f.done; _f = _e.next()) {
