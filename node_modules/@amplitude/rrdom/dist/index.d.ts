import { canvasEventWithTime } from '@amplitude/rrweb-types';
import { canvasMutationData } from '@amplitude/rrweb-types';
import { IMirror } from '@amplitude/rrweb-types';
import { inputData } from '@amplitude/rrweb-types';
import { Mirror as Mirror_2 } from '@amplitude/rrweb-snapshot';
import { NodeType as NodeType_2 } from '@amplitude/rrweb-types';
import { scrollData } from '@amplitude/rrweb-types';
import { serializedNodeWithId } from '@amplitude/rrweb-types';
import { styleDeclarationData } from '@amplitude/rrweb-types';
import { styleSheetRuleData } from '@amplitude/rrweb-types';

export declare class BaseRRCDATASection extends BaseRRNode implements IRRCDATASection {
    readonly nodeName: "#cdata-section";
    readonly nodeType: number;
    readonly RRNodeType = NodeType_2.CDATA;
    data: string;
...
export declare class BaseRRComment extends BaseRRNode implements IRRComment {
    ...
    readonly RRNodeType = NodeType_2.Comment;
    data: string;
    constructor(data: string);
    get textContent(): string;
    set textContent(textContent: string);
...
export declare class BaseRRDocument extends BaseRRNode implements IRRDocument {
    ...
    readonly RRNodeType = NodeType_2.Document;
...
export declare class BaseRRDocumentType extends BaseRRNode implements IRRDocumentType {
    readonly nodeType: number;
    readonly RRNodeType = NodeType_2.DocumentType;
...
export declare class BaseRRElement extends BaseRRNode implements IRRElement {
    readonly nodeType: number;
    readonly RRNodeType = NodeType_2.Element;
    readonly nodeName: string;
    tagName: string;
...
export declare class BaseRRText extends BaseRRNode implements IRRText {
    ...
    readonly RRNodeType = NodeType_2.Text;
    data: string;
    constructor(data: string);
    get textContent(): string;
    set textContent(textContent: string);
