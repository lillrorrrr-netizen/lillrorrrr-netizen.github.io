...
exports.FetchTransport = exports.KEEPALIVE_MAX_BODY_SIZE_BYTES = void 0;
...
exports.KEEPALIVE_MAX_BODY_SIZE_BYTES = 16 * 1024;
...
var FetchTransport = /** @class */ (function (_super) {
    ...
    function FetchTransport(customHeaders, enableKeepalive) {
            ...
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        _a.label = 2;
                    case 2:
                        headers = tslib_1.__assign(tslib_1.__assign({}, this.customHeaders), headers);
                        bodySize = typeof body === 'string' ? body.length : body.byteLength;
                        options = {
                            headers: headers,
                            body: body,
                            method: 'POST',
                            keepalive: this.enableKeepalive && bodySize <= exports.KEEPALIVE_MAX_BODY_SIZE_BYTES,
                        };
